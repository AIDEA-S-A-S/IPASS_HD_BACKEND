...
module.exports.manualCheckUpdate = fs.readFileSync(path.join(__dirname, 'manualCheckUpdate.ts'), 'utf8');
...
module.exports.createRiskLayers = fs.readFileSync(path.join(__dirname, 'createRiskLayers.ts'), 'utf8');
module.exports.updateRiskLayers = fs.readFileSync(path.join(__dirname, 'updateRiskLayers.ts'), 'utf8');
module.exports.deleteRiskLayers = fs.readFileSync(path.join(__dirname, 'deleteRiskLayers.ts'), 'utf8');
module.exports.deleteRiskLayersAll = fs.readFileSync(path.join(__dirname, 'deleteRiskLayersAll.ts'), 'utf8');
...
module.exports.fixUserPhone = fs.readFileSync(path.join(__dirname, 'fixUserPhone.ts'), 'utf8');
